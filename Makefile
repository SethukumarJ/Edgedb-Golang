...
mockgen: ## Generate mock repocitory and usecase functions 
	mockgen -source=pkg/repository/interface/user.go -destination=pkg/mock/repoMock/userRepoMock.go -package=mock
	mockgen -source=pkg/usecase/interface/user.go -destination=pkg/mock/usecaseMock/userUsecaseMock.go -package=mock
	mockgen -source=pkg/usecase/interface/authUsecaseInterface.go -destination=pkg/mock/usecaseMock/authUsecaseMock.go -package=mock